...
attachments = ['Inventory_AWS_default.xls', 'Inventory_AWS_qadev.xls']

# username = 'joe@gmail.com'
# password = 'j0ej0e'
host = 'localhost' # specify port, if required, using this notations

fromaddr = 'arundalal786@gmail.com' # must be a vaild 'from' address in your GApps account
toaddr  = 'arundalal786@gmail.com'
